...
PROJECTS := packages/commons packages/inputs packages/engine packages/camera packages/tile packages/track packages/car packages/game-commons packages/hud $(WEB)
ONLY ?= $(PROJECTS)
FILES ?= .
