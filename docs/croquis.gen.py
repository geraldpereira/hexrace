...
# h         hauteur en sortie, en pas de 20 cm
...
start  exit=12  pos=2 w=3  sh=1,1  h=40  t=1/1/1
       ...
       exit=12  pos=2 w=3  sh=1,1  h=48  t=1/1/1   obs=bump@3
       exit=2   pos=2 w=3  sh=1,1  h=48  t=2/1/1
       exit=12  pos=3 w=2  sh=1,1  h=48  t=2/1/1
       exit=2   pos=3 w=2  sh=1,1  h=48  t=2/1/1   obs=barrier@2 barrier@5
       exit=12  pos=3 w=2  sh=1,1  h=56  t=2/1/1   obs=ramp@3,2
       exit=2   pos=3 w=2  sh=1,1  h=56  t=2/1/1
       exit=12  pos=2 w=3  sh=1,1  h=48  t=1/1/1
       exit=2   pos=2 w=3  sh=1,1  h=48  t=1/1/1   obs=hay@1
