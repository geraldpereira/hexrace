...
export default {
  forbidden: [
    ...
    },
    {
      ...
      comment:
        'Les sous-modules de logique en unités (`entity`, `geometry`, et pour la piste `format` ' +
        'et `generation`) ne lisent ni three.js ni Jolt : ils restent testables seuls (spec ' +
        'technique 2.1).',
      severity: 'error',
      from: {
        path: '^src/(entity|geometry|format|generation)/',
